...
import com.example.demo.map.studentsmap;
...
public class teacher_index {
    ...
    public List<exam_show> teacherlist(@RequestParam(value = "username", defaultValue = "") String username,
                                       @RequestParam(value = "id", defaultValue = "") String subject_id, Model model) {
